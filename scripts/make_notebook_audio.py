    ...
    "cells": [
        ...
        },
        {
            ...
            "source": [
                ...
                "        super(AudioMimicEEG, self).__init__()\n",
                "        # Downsampling CNN\n",
                ...
                "        self.rnn = nn.GRU(hidden_size, hidden_size, num_layers=3, batch_first=True, bidirectional=True)\n",
        ...
        {"cell_type": "markdown", "metadata": {}, "source": ["## 3. Training Loop"]},
        {
            "cell_type": "code",
            "execution_count": None,
            "metadata": {},
            ...
            "source": [
                ...
                "            input_lengths = torch.full(size=(batch_size,), fill_value=feat.size(1)//4, dtype=torch.long)\n",
                ...
                "        \n",
                "    torch.save(model.state_dict(), os.path.join(MODELS_DIR, 'audio_mimic_checkpoint.pth'))\n",
                "    \n",
...
with open("training/train_eeg_audio.ipynb", "w") as f:
    json.dump(notebook, f, indent=1)
print("Created training/train_eeg_audio.ipynb successfully.")
